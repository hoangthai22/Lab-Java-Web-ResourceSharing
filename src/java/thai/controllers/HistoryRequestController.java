 ...
 * @author ASUS
 */
@WebServlet(name = "HistoryRequestController", urlPatterns = {"/HistoryRequestController"})
public class HistoryRequestController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingObj> listBooking = dao.getBookingByUserID(user.getUserId());
